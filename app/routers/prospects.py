...
def _to_out(p) -> ProspectOut:
    return ProspectOut(
        ...
        timing_score=getattr(p, "timing_score", 0) or 0,
        contactability_score=getattr(p, "contactability_score", 0) or 0,
        acquisition_score=getattr(p, "acquisition_score", 0) or 0,
